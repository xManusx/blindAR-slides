...
\logo{}
    ...
    \setbeamertemplate{footline}{}
		\begin{frame}[noframenumbering,plain,c]{}
			...
			%\vspace{2.3cm}
			\centering
{\includegraphics[width=.4\textwidth]{themefau/art/logo_bold.pdf}}
	\vspace{1cm}
...
\logo{\includegraphics[width=.15\textwidth]{themefau/art/logo_bold.pdf}}
  \maketitle
...
%\includepdf[pages=1]{persona_canvas.pdf}
%}
	\begin{frame}[noframenumbering,plain,c]{}
		\centering
		\includegraphics[height=1.25\textheight]{persona_canvas.JPG}
\end{frame}
